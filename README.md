...
burden to fit the operators to the fixed-sized pages. For more details, please refer to [our FPT2022 paper](https://ic.ese.upenn.edu/abstracts/nested_dfx_fpt2022.html).
...
After all parallel compile jobs are done, in `/<PROJECT_DIR>/`, do below to print out the compile time measurement. 
```
make report
```
...
For a comparison against the monolithic flow of Vitis, refer to 
[Rosetta Benchmark on ZCU102](https://github.com/icgrp/rosetta_vitis/tree/zcu102(2021.1)).
