...
#pragma HLS INTERFACE axis register port=Output_3 // winner
    ...
    bool is_input_1_read = Input_1.read_nb(input_1_tmp);
    bool is_input_2_read = Input_2.read_nb(input_2_tmp);
    if(is_input_1_read == true && is_input_2_read == true){
    ...
    else if(is_input_1_read == true && is_input_2_read == false){
        if(counter_1 < COUNTER*num_inputs){
            counter_1 = counter_1 + 1;
        }
        Output_1.write(input_1_tmp);
    }
    else if(is_input_1_read == false && is_input_2_read == true){
        if(counter_1 < COUNTER*num_inputs){
            counter_1 = counter_1 + 1;
        }
        Output_2.write(input_2_tmp);
    ...
    bool is_input_3_read = Input_3.read_nb(input_3_tmp);
    bool is_input_4_read = Input_4.read_nb(input_4_tmp);
    if(is_input_3_read == true && is_input_4_read == true){
        if(counter_2 < COUNTER*num_inputs){
            counter_2 = counter_2 + 2;
        }
    }
    else if(is_input_3_read == true && is_input_4_read == false){
        if(counter_2 < COUNTER*num_inputs){
            counter_2 = counter_2 + 1;
        }
    }
    else if(is_input_3_read == false && is_input_4_read == true){
        if(counter_2 < COUNTER*num_inputs){
            counter_2 = counter_2 + 1;
        }
    }

	if(counter_1 == COUNTER*num_inputs && eval_1_done == false){
		Output_3.write(1);
		eval_1_done = true;
	}
	else if(counter_2 == COUNTER*num_inputs && eval_2_done == false){
		Output_3.write(2);
		eval_2_done = true;
	}	

	// // evaluation done, enter only once
	// if((counter_1 == COUNTER*num_inputs || counter_2 == COUNTER*num_inputs) && \
 //                                                        (eval_done == false)){
	// 	if(counter_1 == COUNTER*num_inputs){
	// 		winner = 1;
	// 	}
	...
	// if((counter_1 + counter_2 == 2*num_inputs*COUNTER) && (winner_sent == false)){ 
