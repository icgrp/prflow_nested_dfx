...
#pragma HLS STREAM variable=Output_r2_even_bot_2 depth=default_depth
  ...
  TRIANGLES: for (int i = 0; i < NUM_3D_TRI/2; i++)
  {
    ...
    t_1(Output_redir_odd, Output_redir_odd_1, Output_redir_odd_2);
    t_2(Output_redir_even, Output_redir_even_1, Output_redir_even_2);
    // t2_1(Output_redir_odd, Output_redir_even, Output_redir_odd_1, Output_redir_odd_2,
    ...
    // printf("tansem consumer starts\n");
    // Output_2 is winner
    // tandem_consumer(Output_r2_odd_top_0, Output_r2_odd_bot_0, Output_r2_even_top_0, Output_r2_even_bot_0,
    //   Output_r2_odd_top_1, Output_r2_odd_bot_1, Output_r2_even_top_1, Output_r2_even_bot_1,
    //   Output_r2_odd_top, Output_r2_odd_bot, Output_r2_even_top, Output_r2_even_bot, Output_2);

    tc_1(Output_r2_odd_top_1, Output_r2_odd_top_2, Output_r2_odd_top, winner_1);
    tc_2(Output_r2_odd_bot_1, Output_r2_odd_bot_2, Output_r2_odd_bot, winner_2);
    tc_3(Output_r2_even_top_1, Output_r2_even_top_2, Output_r2_even_top, winner_3);
    tc_4(Output_r2_even_bot_1, Output_r2_even_bot_2, Output_r2_even_bot, winner_4);
    ...
    //       Output_r2_even_top, Output_r2_evn_bot, winner_2);
