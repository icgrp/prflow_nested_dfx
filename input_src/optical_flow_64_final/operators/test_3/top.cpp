...
//  #pragma HLS STREAM variable=frame3_b depth=default_depth
  ...
  gradient_weight_x1(y_filtered_x,filtered_gradient_x1);
  gradient_weight_x2(y_filtered_y,filtered_gradient_y1);
  gradient_weight_x3(y_filtered_z,filtered_gradient_z1);
