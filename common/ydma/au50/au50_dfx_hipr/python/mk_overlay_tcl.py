...
for line in file_in:
  if copy_enable:
    if (line.replace('add_files', '') != line):
      ...
      file_out.write('add_files ../../../../../../../au50_dfx_hipr/checkpoint/page.dcp\n')
      file_out.write('add_files ../../../../../../../au50_dfx_hipr/xdc/sub.xdc\n')
      ...
      file_out.write('set_property USED_IN {implementation} [get_files ../../../../../../../au50_dfx_hipr/xdc/sub.xdc]\n')
      file_out.write('set_property PROCESSING_ORDER LATE [get_files ../../../../../../../au50_dfx_hipr/xdc/sub.xdc]\n')
