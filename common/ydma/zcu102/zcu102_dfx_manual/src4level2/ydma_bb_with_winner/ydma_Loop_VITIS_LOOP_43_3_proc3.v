...
module ydma_Loop_VITIS_LOOP_43_3_proc3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (m_axi_aximm2_ARREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_58 <= 31'd0;
    end else if (((icmp_ln43_fu_126_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_fu_58 <= add_ln43_fu_131_p2;
    end
end
...
always @ (*) begin
    if ((icmp_ln43_fu_126_p2 == 1'd0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln43_fu_126_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln43_fu_126_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
assign add_ln43_fu_131_p2 = (i_fu_58 + 31'd1);
...
assign icmp_ln43_fu_126_p2 = (($signed(i_2_cast_fu_122_p1) < $signed(input_size)) ? 1'b1 : 1'b0);
...
endmodule //ydma_Loop_VITIS_LOOP_43_3_proc3
