...
module ydma_Block_split41_proc5_Pipeline_VITIS_LOOP_50_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [61:0] sext_ln321_5;
input  [31:0] winner_size;
input  [63:0] input3;
output  [31:0] v3_buffer_V_din;
input   v3_buffer_V_full_n;
output   v3_buffer_V_write;
...
reg    v3_buffer_V_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [31:0] aximm3_addr_read_reg_158;
...
wire  signed [63:0] sext_ln321_5_cast_fu_97_p1;
reg   [30:0] i_fu_56;
wire   [30:0] add_ln50_fu_125_p2;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] i_4_cast_fu_116_p1;
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (m_axi_aximm3_ARREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_56 <= 31'd0;
    end else if (((icmp_ln50_fu_120_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_fu_56 <= add_ln50_fu_125_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        aximm3_addr_read_reg_158 <= m_axi_aximm3_RDATA;
    end
end
...
always @ (*) begin
    if (((ap_start == 1'b0) | (m_axi_aximm3_ARREADY == 1'b0))) begin
...
always @ (*) begin
    if ((icmp_ln50_fu_120_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        aximm3_blk_n_AR = m_axi_aximm3_ARREADY;
    end else begin
        aximm3_blk_n_AR = 1'b1;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        aximm3_blk_n_R = m_axi_aximm3_RVALID;
    end else begin
        aximm3_blk_n_R = 1'b1;
    end
end
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        v3_buffer_V_blk_n = v3_buffer_V_full_n;
    end else begin
        v3_buffer_V_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        v3_buffer_V_write = 1'b1;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln50_fu_120_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln50_fu_120_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
assign add_ln50_fu_125_p2 = (i_fu_56 + 31'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (v3_buffer_V_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm3_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (v3_buffer_V_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm3_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & (v3_buffer_V_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm3_RVALID == 1'b0)));
end

assign ap_block_state71_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state72_pp0_stage0_iter1 = (m_axi_aximm3_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state73_pp0_stage0_iter2 = (v3_buffer_V_full_n == 1'b0);
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign ap_ext_blocking_cur_n = (aximm3_blk_n_R & aximm3_blk_n_AR);

assign ap_ext_blocking_n = (ap_ext_blocking_cur_n & 1'b1);

assign ap_int_blocking_cur_n = v3_buffer_V_blk_n;

assign ap_int_blocking_n = (ap_int_blocking_cur_n & 1'b1);

assign ap_str_blocking_n = (1'b1 & 1'b1);

assign i_4_cast_fu_116_p1 = i_fu_56;

assign icmp_ln50_fu_120_p2 = (($signed(i_4_cast_fu_116_p1) < $signed(winner_size)) ? 1'b1 : 1'b0);

assign m_axi_aximm3_ARADDR = sext_ln321_5_cast_fu_97_p1;
...
assign m_axi_aximm3_ARLEN = winner_size;
...
assign m_axi_aximm3_AWADDR = 64'd0;
...
assign m_axi_aximm3_AWLEN = 32'd0;
...
assign m_axi_aximm3_AWVALID = 1'b0;

assign m_axi_aximm3_BREADY = 1'b0;

assign m_axi_aximm3_WDATA = 32'd0;

assign m_axi_aximm3_WID = 1'd0;

assign m_axi_aximm3_WLAST = 1'b0;

assign m_axi_aximm3_WSTRB = 4'd0;

assign m_axi_aximm3_WUSER = 1'd0;

assign m_axi_aximm3_WVALID = 1'b0;

assign sext_ln321_5_cast_fu_97_p1 = $signed(sext_ln321_5);

assign v3_buffer_V_din = aximm3_addr_read_reg_158;

endmodule //ydma_Block_split41_proc5_Pipeline_VITIS_LOOP_50_5
