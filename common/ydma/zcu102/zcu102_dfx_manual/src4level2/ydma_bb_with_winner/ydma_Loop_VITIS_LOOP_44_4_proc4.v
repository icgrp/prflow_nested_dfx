...
module ydma_Loop_VITIS_LOOP_44_4_proc4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln44_fu_133_p2;
reg    ap_condition_pp0_exit_iter0_state2;
wire  signed [63:0] sext_ln321_fu_110_p1;
reg    ap_block_pp0_stage0_01001;
reg   [30:0] i_fu_62;
wire   [30:0] add_ln44_fu_138_p2;
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (m_axi_aximm2_AWREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_62 <= 31'd0;
    end else if (((icmp_ln44_fu_133_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_fu_62 <= add_ln44_fu_138_p2;
    end
end
...
always @ (*) begin
    if ((icmp_ln44_fu_133_p2 == 1'd0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln44_fu_133_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln44_fu_133_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
assign add_ln44_fu_138_p2 = (i_fu_62 + 31'd1);
...
assign icmp_ln44_fu_133_p2 = (($signed(i_3_cast_fu_129_p1) < $signed(p_read)) ? 1'b1 : 1'b0);
...
endmodule //ydma_Loop_VITIS_LOOP_44_4_proc4
