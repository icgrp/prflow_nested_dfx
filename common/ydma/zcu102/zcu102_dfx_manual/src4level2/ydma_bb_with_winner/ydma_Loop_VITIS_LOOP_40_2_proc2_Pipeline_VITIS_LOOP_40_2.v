...
module ydma_Loop_VITIS_LOOP_40_2_proc2_Pipeline_VITIS_LOOP_40_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if ((~((m_axi_aximm1_AWREADY == 1'b0) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_60 <= 31'd0;
    end else if (((icmp_ln40_fu_127_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_fu_60 <= add_ln40_fu_132_p2;
    end
end
...
always @ (*) begin
    if ((icmp_ln40_fu_127_p2 == 1'd0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln40_fu_127_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)) & ~((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln40_fu_127_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
...
assign add_ln40_fu_132_p2 = (i_fu_60 + 31'd1);
...
assign icmp_ln40_fu_127_p2 = (($signed(i_1_cast_fu_123_p1) < $signed(config_size_load)) ? 1'b1 : 1'b0);
...
endmodule //ydma_Loop_VITIS_LOOP_40_2_proc2_Pipeline_VITIS_LOOP_40_2
