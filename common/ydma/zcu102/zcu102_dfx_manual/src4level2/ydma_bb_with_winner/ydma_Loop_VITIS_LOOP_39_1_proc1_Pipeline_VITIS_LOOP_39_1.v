...
module ydma_Loop_VITIS_LOOP_39_1_proc1_Pipeline_VITIS_LOOP_39_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [63:0] aximm1_addr_read_reg_158;
...
wire  signed [63:0] sext_ln321_4_cast_fu_97_p1;
reg   [30:0] i_fu_56;
wire   [30:0] add_ln39_fu_125_p2;
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (m_axi_aximm1_ARREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_56 <= 31'd0;
    end else if (((icmp_ln39_fu_120_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_fu_56 <= add_ln39_fu_125_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        aximm1_addr_read_reg_158 <= m_axi_aximm1_RDATA;
    end
end
...
always @ (*) begin
    if (((ap_start == 1'b0) | (m_axi_aximm1_ARREADY == 1'b0))) begin
...
always @ (*) begin
    if ((icmp_ln39_fu_120_p2 == 1'd0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln39_fu_120_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln39_fu_120_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
assign add_ln39_fu_125_p2 = (i_fu_56 + 31'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (v1_buffer_V_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (v1_buffer_V_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & (v1_buffer_V_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm1_RVALID == 1'b0)));
end

assign ap_block_state71_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state72_pp0_stage0_iter1 = (m_axi_aximm1_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state73_pp0_stage0_iter2 = (v1_buffer_V_full_n == 1'b0);
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign ap_ext_blocking_cur_n = (aximm1_blk_n_R & aximm1_blk_n_AR);
...
assign i_cast_fu_116_p1 = i_fu_56;

assign icmp_ln39_fu_120_p2 = (($signed(i_cast_fu_116_p1) < $signed(config_size)) ? 1'b1 : 1'b0);

assign m_axi_aximm1_ARADDR = sext_ln321_4_cast_fu_97_p1;
...
assign m_axi_aximm1_ARLEN = config_size;
...
assign sext_ln321_4_cast_fu_97_p1 = $signed(sext_ln321_4);

assign v1_buffer_V_din = aximm1_addr_read_reg_158;

endmodule //ydma_Loop_VITIS_LOOP_39_1_proc1_Pipeline_VITIS_LOOP_39_1
