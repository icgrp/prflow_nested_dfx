...
module ydma_Block_split41_proc5_Pipeline_VITIS_LOOP_51_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [61:0] sext_ln321_6;
input  [31:0] winner_size;
input  [31:0] v3_buffer_V_dout;
input   v3_buffer_V_empty_n;
output   v3_buffer_V_read;
input  [63:0] winner;
...
reg   [31:0] v3_buffer_V_read_reg_164;
...
wire  signed [63:0] sext_ln321_6_cast_fu_104_p1;
reg    ap_block_pp0_stage0_01001;
reg   [30:0] i_1_fu_60;
wire   [30:0] add_ln51_fu_132_p2;
wire   [31:0] i_5_cast_fu_123_p1;
reg   [69:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_condition_pp0_exit_iter0_state2) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((m_axi_aximm3_AWREADY == 1'b0) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if ((~((m_axi_aximm3_AWREADY == 1'b0) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_1_fu_60 <= 31'd0;
    end else if (((icmp_ln51_fu_127_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_1_fu_60 <= add_ln51_fu_132_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        v3_buffer_V_read_reg_164 <= v3_buffer_V_dout;
    end
end
...
always @ (*) begin
    if (((m_axi_aximm3_AWREADY == 1'b0) | (ap_start == 1'b0))) begin
...
always @ (*) begin
    if ((m_axi_aximm3_BVALID == 1'b0)) begin
...
always @ (*) begin
    if ((icmp_ln51_fu_127_p2 == 1'd0)) begin
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((1'b1 == ap_CS_fsm_state72) & (m_axi_aximm3_BVALID == 1'b1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state72) & (m_axi_aximm3_BVALID == 1'b1))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        v3_buffer_V_blk_n = v3_buffer_V_empty_n;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln51_fu_127_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)) & ~((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln51_fu_127_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
...
assign add_ln51_fu_132_p2 = (i_1_fu_60 + 31'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (v3_buffer_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & (v3_buffer_V_empty_n == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (m_axi_aximm3_WREADY == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter1 == 1'b1) & (v3_buffer_V_empty_n == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (m_axi_aximm3_WREADY == 1'b0)));
end

assign ap_block_state2_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (v3_buffer_V_empty_n == 1'b0);
end
...
assign i_5_cast_fu_123_p1 = i_1_fu_60;

assign icmp_ln51_fu_127_p2 = (($signed(i_5_cast_fu_123_p1) < $signed(winner_size)) ? 1'b1 : 1'b0);
...
assign m_axi_aximm3_AWADDR = sext_ln321_6_cast_fu_104_p1;
...
assign m_axi_aximm3_AWLEN = winner_size;
...
assign m_axi_aximm3_WDATA = v3_buffer_V_read_reg_164;

assign m_axi_aximm3_WID = 1'd0;

assign m_axi_aximm3_WLAST = 1'b0;

assign m_axi_aximm3_WSTRB = 4'd15;

assign m_axi_aximm3_WUSER = 1'd0;

assign sext_ln321_6_cast_fu_104_p1 = $signed(sext_ln321_6);

endmodule //ydma_Block_split41_proc5_Pipeline_VITIS_LOOP_51_6
